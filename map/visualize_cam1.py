...
calib.load_intrinsic("output/cam1/intrinsic.yaml")
calib.load_extrinsic("output/cam1/extrinsic.yaml")
...
# img = cv2.imread("C:/Users/admin/project/calibcam/images/camera_1/4k-test/IMG_20251206_125324.jpeg")
