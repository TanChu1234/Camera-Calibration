...
# calib.load_intrinsic("output/cam2/intrinsic.yaml")
# calib.load_extrinsic("output/cam2/extrinsic.yaml")
...
img = cv2.imread("C:/Users/admin/project/calibcam/images/camera_2/raw/camera2_v4_00015.jpg")
