...
calib.load_intrinsic("output/cam3/intrinsic.yaml")
calib.load_extrinsic("output/cam3/extrinsic.yaml")
...
# img = cv2.imread("C:/Users/admin/project/calibcam/images/camera_3/raw_2/camera3_v5_00004.jpg")
